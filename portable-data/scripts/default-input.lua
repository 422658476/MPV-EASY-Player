...
mp.add_key_binding("0", "default_volume_up_b",  function() mp.command("add volume 2;"..settings.default_volume_value) end)

--鼠标和键盘音量-
mp.add_key_binding("WHEEL_DOWN", "default_volume_down_a",  function() mp.command("add volume -2;"..settings.default_volume_value) end)
mp.add_key_binding("9", "default_volume_down_b",  function() mp.command("add volume -2;"..settings.default_volume_value) end)
...
--方向键跳转进度
mp.add_key_binding("RIGHT", "default_seek_up",  function() mp.command("seek  10") end)
mp.add_key_binding("LEFT", "default_seek_down",  function() mp.command("seek  -10") end)
mp.add_key_binding("UP", "default_seek_up_up",  function() mp.command("seek  60") end)
mp.add_key_binding("DOWN", "default_seek_down_down",  function() mp.command("seek  -60") end)

--对比度
mp.add_key_binding("2", "default_contrast_up",  function() mp.command("add contrast 1;"..settings.default_contrast_value) end)
mp.add_key_binding("1", "default_contrast_down",  function() mp.command("add contrast -1;"..settings.default_contrast_value) end)

--亮度
mp.add_key_binding("4", "default_brightness_up",  function() mp.command("add brightness 1;"..settings.default_brightness_value) end)
mp.add_key_binding("3", "default_brightness_down",  function() mp.command("add brightness -1;"..settings.default_brightness_value) end)

--伽马
mp.add_key_binding("6", "default_gamma_up",  function() mp.command("add gamma 1;"..settings.default_gamma_value) end)
mp.add_key_binding("5", "default_gamma_down",  function() mp.command("add gamma -1;"..settings.default_gamma_value) end)

--饱和度
mp.add_key_binding("8", "default_saturation_up",  function() mp.command("add saturation 1;"..settings.default_saturation_value) end)
mp.add_key_binding("7", "default_saturation_down",  function() mp.command("add saturation -1;"..settings.default_saturation_value) end)
