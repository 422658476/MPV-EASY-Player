...
local osc_styles = {
    ...
    rjno150Buttons = "{\\blur0\\bord0\\1c&H717171\\3c&HFFFFFF\\fs42\\fnmpv-osd-symbols}",
    rjno140Buttons = "{\\blur0\\bord0\\1c&H717171\\3c&HFFFFFF\\fs28\\fnmpv-osd-symbols}",
    rjno130Buttons = "{\\blur0\\bord0\\1c&H717171\\3c&HFFFFFF\\fs26\\fnmpv-osd-symbols}",
    rjno125Buttons = "{\\blur0\\bord0\\1c&H717171\\3c&HFFFFFF\\fs25\\fnmpv-osd-symbols}",
    rjno120Buttons = "{\\blur0\\bord0\\1c&H717171\\3c&HFFFFFF\\fs20\\fnmpv-osd-symbols}",
...
layouts["box"] = function ()
    ...
    lo.geometry = {x = posX, y = posY, an = 5, w = 1100, h = 43}
    lo.layer = 10
...
if user_opts["seekbarstyle"] == "knob" then 
    ...
    lo.geometry = {x = rjno1X + 10 * 3.5 * 2 + 10 * 3 -8-60-1+3, y = rjno1Y + 10 * 1.6 * 0 + 50 / 2-4 , an = 5, w = 30, h = 50}
    lo.style = osc_styles.rjno140Buttons	

	
    lo = add_layout("playpause")
    lo.geometry = {x = rjno1X + 10 * 3.5 * 3 + 10 * 3 -8-60+11+3, y = rjno1Y + 10 * 1.6 * 0 + 50 / 2-4, an = 5, w = 30, h = 50}
    lo.style = osc_styles.rjno150Buttons		
	
		
    lo = add_layout("skipfrwd")
    lo.geometry = {x = rjno1X + 10 * 3.5 * 4 + 10 * 3 -8-60+31+3, y = rjno1Y + 10 * 1.6 * 0 + 50 / 2-4 , an = 5, w = 30, h = 50}
    lo.style = osc_styles.rjno140Buttons	
