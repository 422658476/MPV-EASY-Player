...
local osc_styles = {
    bigButtons = "{\\blur0\\bord0\\1c&H504C46\\3c&HFFFFFF\\fs40\\fnmpv-osd-symbols}",
    smallButtonsL = "{\\blur0\\bord0\\1c&H504C46\\3c&HFFFFFF\\fs19\\fnmpv-osd-symbols}",
    smallButtonsLlabel = "{\\fscx105\\fscy105\\fn" .. mp.get_property("options/osd-font") .. "}",
    smallButtonsR = "{\\blur0\\bord0\\1c&H504C46\\3c&HFFFFFF\\fs30\\fnmpv-osd-symbols}",
    topButtons = "{\\blur0\\bord0\\1c&H504C46\\3c&HFFFFFF\\fs12\\fnmpv-osd-symbols}",

    elementDown = "{\\1c&H999999}",
    timecodes = "{\\blur0\\bord0\\1c&H21B802\\3c&HFFFFFF\\fs18}",
    vidtitle = "{\\blur0\\bord0\\1c&H25282A\\3c&HFFFFFF\\fs18\\q2}",
    box = "{\\rDefault\\blur0\\bord0\\1c&HE6E6E6\\3c&HFFFFFF}",

    topButtonsBar = "{\\blur0\\bord0\\1c&H504C46\\3c&HFFFFFF\\fs19\\fnmpv-osd-symbols}",
    smallButtonsBar = "{\\blur0\\bord0\\1c&H504C46\\3c&HFFFFFF\\fs25\\fnmpv-osd-symbols}",
    timecodesBar = "{\\blur0\\bord0\\1c&H504C46\\3c&HFFFFFF\\fs27}",
    timePosBar = "{\\blur0\\bord".. user_opts.tooltipborder .."\\1c&HFFFFFF\\3c&H000000\\fs30}",
    vidtitleBar = "{\\blur0\\bord0\\1c&H33312D\\3c&HFFFFFF\\fs18\\q2}",
}
...
if user_opts["seekbarstyle"] ~= "knob" then   
   ...
   new_element("bgbar1", "box")
    ...
    lo.alpha[1] =
        math.min(255, user_opts.boxalpha + (255 - user_opts.boxalpha)*0.5)
