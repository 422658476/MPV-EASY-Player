...
---
#### 使用文字说明可能还是会带来很多理解上的困扰，没有关系，你可以先从[release](https://github.com/422658476/MPV-EASY-Player/releases)下载一个已经打包好的实例：【首页教程示例使用：mpv-0.28.2-i686-20180324(基于第一种方法,纯英文路径下使用)】，边使用边看下方的文字。
---
...
>>注意：上方图片中第二个箭头是错误的，应该是从左侧【scripts】文件夹指向右侧的【scripts】文件夹
